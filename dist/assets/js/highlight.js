...
(function($) {
    ...
    var SelectionSharer = function(options) {
      ...
      this.shareTwitter = function(e) {
        ...
        var url = 'https://telegram.me/share/url?url=' +encodeURIComponent(window.location.href) + '&text='+encodeURIComponent(text)
      ...
      this.render = function() {
        var popoverHTML =  '<div class="selectionSharer" id="selectionSharerPopover" style="position:absolute;">'
                         ...
                         + '    <ul>'
                         + '      <li><a class="action tg" href="" title="Share this selection on Telegram" target="_blank">Telegram</a></li>'
        ...
        self.$popover.find('a.tg').click(self.shareTwitter);
        ...
        self.$popunder.find('a.tg').click(self.shareTwitter);
